...
const { authUser, registerUser, getUserProfile, getUsers, updateUserStatus, deleteUser, createUser, updateUser, verifyReferral, getCustomerVisits, getUserById } = require('../controllers/userController');
